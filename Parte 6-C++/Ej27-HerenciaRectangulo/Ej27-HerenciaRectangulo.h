#ifndef EJ27-HERENCIARECTANGULO_H // directivas de preprocesador para evitar
#define EJ27-HERENCIARECTANGULO_H // inclusiones múltiples del archivo de encabezado
